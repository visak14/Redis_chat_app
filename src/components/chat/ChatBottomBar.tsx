...
import { sendMesssageAction } from '@/actions/message.action'
...
const ChatBottomBar = () => {
    ...
    const [playNotoficationSound] = useSound("/sounds/notification.mp3")
    ...
    }, [currentUser?.id, selectedUser?.id,  queryClient, playNotoficationSound, soundEnabled])
